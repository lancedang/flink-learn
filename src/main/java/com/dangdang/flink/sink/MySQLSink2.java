...
public class MySQLSink2 extends RichSinkFunction<List<Student>> {

    private static final Logger log = LoggerFactory.getLogger(MySQLSink2.class);
     ...
     */
    @Override
    public void invoke(List<Student> values, Context context) throws Exception {
        if (ps == null) {
            return;
        }
        //遍历数据集合
